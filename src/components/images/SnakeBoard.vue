...
<template>
  <svg width="512" height="478" viewBox="0 0 512 478" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g filter="url(#filter1_di_0_1)">
      <circle cx="20.2305" cy="20.2711" r="6.5" fill="url(#paint1_radial_0_1)" />
    </g>
    <path d="M17.4609 22.5657L22.9995 17.9763M17.4609 17.9763L22.9995 22.5657" stroke="#114944" />
    <g filter="url(#filter2_di_0_1)">
      <circle cx="20.2305" cy="457.431" r="6.5" fill="url(#paint2_radial_0_1)" />
    </g>
    <path d="M17.4609 459.726L22.9995 455.136M17.4609 455.136L22.9995 459.726" stroke="#093430" />
    <g filter="url(#filter3_di_0_1)">
      <circle cx="491.73" cy="20.2711" r="6.5" fill="url(#paint3_radial_0_1)" />
    </g>
    <path d="M488.961 22.5657L494.5 17.9763M488.961 17.9763L494.5 22.5657" stroke="#114944" />
    <g filter="url(#filter4_di_0_1)">
      <circle cx="491.73" cy="457.431" r="6.5" fill="url(#paint4_radial_0_1)" />
    </g>
    ...
    <defs>
      ...
      <radialGradient
        ...
        r="1"
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(20.2305 17.2711) rotate(90) scale(9.5)"
      >
      ...
      <radialGradient
        ...
        r="1"
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(20.2305 454.431) rotate(90) scale(9.5)"
      >
      ...
      <radialGradient
        ...
        r="1"
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(491.73 17.2711) rotate(90) scale(9.5)"
      >
